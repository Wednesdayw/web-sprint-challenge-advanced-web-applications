...
Tokens are used for authentication. They can authenticate a users login information for them to gain access to data. 

2. What steps can you take in your web apps to keep your data secure?
Being cautious and self aware about where you're posting or storing your token. Giving only authorized users tokens to view and gain access to the data. 

3. Describe how web servers work.
Web servers process incoming network requests over HTTP and other related protocols. The purpose of a web server is to store, process and deliver web pages to clients. 
